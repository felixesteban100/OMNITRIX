...
function OmnitrixBrandNew() {
    ...
    return (
        ...
        >
                            ...
                            return (
                                <div key={currentAlienInView.name} className={`w-[100%] absolute z-50 h-0 flex justify-center items-center translate-y-80`}>
                                    <img
                                        style={
                                            toogleInvertValue ?
                                                { filter: `invert(46%) sepia(90%) saturate(220%) hue-rotate(500deg) brightness(112%) contrast(200%)` }
                                                :
                                                {}
                                        }
                                        className={
            ...
            <div className={`${alienTransformed ? "animate-omnitrixRotateDown" : "animate-omnitrixRotateUp"} min-h-[80vh] w-[50%] max-w-[500px] bg-secondary rounded-lg mx-auto flex items-center`}>
                <div
                    className={
                        `bg-transparent md:bg-neutral 
                            mx-auto 
                            h-[80vh] w-[50%] max-w-[250px] p-20
                            rounded-md 
                    ...
                    <div className='flex justify-center items-center'>
                        <div className='relative flex justify-center items-center'>
                            <div
                                ...
                                className={`absolute btn hover:bg-gray-400  ${alienTransformed ? "" : ""} h-[5rem] w-[45rem] lg:w-[50rem] lg:h-[5rem] bg-accent rounded-3xl`}
                            />
                            <div
                                onClick={() => {
                                    selectPreviousAlien()
...
export default OmnitrixBrandNew
